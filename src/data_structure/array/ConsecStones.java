...
* 3 stones are on a number line at positions a, b, and c.

* Formally, let's say the stones are currently at positions
* x, y, z with x < y < z.  You pick up the stone at either position
* x or position z, and move that stone to an integer position k,
* with x < k < z and k != y.
...
* moves that you could have made?
