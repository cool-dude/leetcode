...
and a top-right point. For example, a unit square is
represented as [1,1,2,2]. (coordinate of bottom-left
...
Return true. All 5 rectangles together form an
...
Return false. Because two of the rectangles
