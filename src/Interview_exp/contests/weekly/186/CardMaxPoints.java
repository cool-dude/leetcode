/*LC423: Maximum Points You Can Obtain from Cards
...
In one step, you can take one card from
the beginning or from the end of the row.
...
//The result is always in continuous K elements
//from the begin and end of cardPoints array.
class Sln{
