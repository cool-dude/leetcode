...
Output: [0,3]
Explanation: It's not possible to reach all the nodes
from a single vertex. From 0 we can reach [0,1,2,5].
...
reachable from any other node, so we must include them.
