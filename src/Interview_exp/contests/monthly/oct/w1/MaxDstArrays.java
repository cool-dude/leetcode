...
Given m arrays, and each array is sorted
in ascending order. Now you can pick up
2 integers from two different arrays (each array picks one)
and calculate the distance. We define the distance
between two integers a and b to be their
