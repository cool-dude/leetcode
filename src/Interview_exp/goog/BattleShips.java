...
* are in it. The battleships are represented with 'X's,
...
At least one horizontal or vertical cell
...
XXXX
...X*/
/*Going over all cells, we can count
only those that are the "first" cell of the battleship.
First cell will be defined as the most top-left cell.
We can check for first cells by only counting cells
