'''
Let’s say we want to track any Amazon product price
and grab the deal when the price changes below our
defined price. Let’s write a Python script for this.
Below is the code:
'''
