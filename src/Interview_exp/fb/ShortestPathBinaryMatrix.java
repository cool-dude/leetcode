...
* has length k if and only if it is composed
...
Return the length of the shortest such clear path
* from top-left to bottom-right.  If such a path does not exist, return -1.*/
class Sln{
