...
https://leetcode.com/problems/car-pooling/
 You are driving a vehicle that has capacity empty
 seats initially available for passengers.
...
due east from your vehicle's initiaxl location.

Return true if and only if it is possible to pick up
